...
#include "OrganizationMemberModel.h"
...
void OrganizationMemberModel::refresh()
{
...
QVariant OrganizationMemberModel::data(const QModelIndex &index, int role) const
{
...
QHash<int, QByteArray> OrganizationMemberModel::roleNames() const
{
