...
void RoomGroupModel::refresh()
{

}

QVariant RoomGroupModel::data(const QModelIndex &index, int role) const
{
...
QHash<int, QByteArray> RoomGroupModel::roleNames() const
{
