...
#include "RoomTaskModel.h"

RoomTaskModel::RoomTaskModel()
{
...
void RoomTaskModel::refresh()
{

}

QVariant RoomTaskModel::data(const QModelIndex &index, int role) const
{
...
QHash<int, QByteArray> RoomTaskModel::roleNames() const
{
