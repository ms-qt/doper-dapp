...
#include "RoomMenberModel.h"


RoomMenberModel::RoomMenberModel()
{
...
void RoomMenberModel::refresh()
{

}

QVariant RoomMenberModel::data(const QModelIndex &index, int role) const
{
...
QHash<int, QByteArray> RoomMenberModel::roleNames() const
{
