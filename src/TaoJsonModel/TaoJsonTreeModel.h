...
public:
    ...
    Q_INVOKABLE void loadFromJsonString(const QString& jsonValue,const QString& recursionKey = cRecursionKey);
	Q_INVOKABLE void loadFromName( const QString& recursionKey = cRecursionKey);
    //导出到json文件
