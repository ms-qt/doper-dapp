...
#include "BaseQQuickView.h"

static QRect MoveArea;

BaseQQuickView::BaseQQuickView(QWindow *parent)
        : QQuickView(parent)
{

    baseEngine = this->engine();
...
bool BaseQQuickView::movable() const
{
    return m_movable;
}

void BaseQQuickView::setMovable(bool arg)
{
    if (m_movable != arg)
    {
        m_movable = arg;
...
bool BaseQQuickView::resizable() const
{
    return m_resizable;
}

void BaseQQuickView::setResizable(bool arg)
{
    if (m_resizable != arg)
    {
        m_resizable = arg;
...
void BaseQQuickView::mousePressEvent(QMouseEvent *event)
{
...
void BaseQQuickView::mouseReleaseEvent(QMouseEvent *event)
{
    m_oldPos = position();
...
void BaseQQuickView::mouseDoubleClickEvent(QMouseEvent *event)
{
...
void BaseQQuickView::mouseMoveEvent(QMouseEvent *event)
{
...
BaseQQuickView::MouseArea BaseQQuickView::getArea(const QPoint &pos)
{
    int x = pos.x();
    int y = pos.y();
    int w = width();
...
void BaseQQuickView::setWindowGeometry(const QPoint &pos)
{
...
void BaseQQuickView::setCursorIcon()
{
