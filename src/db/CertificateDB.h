...
public:
    ...
    //    QList<CertificateBean *> queryAll();
    //
    //    CertificateBean queryIdBy(int id);
    //
    //    CertificateBean queryUserIdBy(int _user_id);
    //
    //    void updateIdByAccessToken(int id, QString access_token);
    //
    //    void updateIdByRefreshAccessToken(int id, QString refresh_token);
    //
    //    void updateUserIdByAccessToken(QString userId, QString access_token);
    //
    //    void updateUserIdByRefreshAccessToken(QString userId, QString refresh_token);
