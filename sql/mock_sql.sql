...
INSERT INTO _user (_user_id, _name, _age, _sex, _department, _job_title, _avatar, _signature, _phonenumber, _email, _qq,_introduction, _company) VALUES ('liweining', '李卫宁', 22, true, '董事长', '平台管理',  'https://b-ssl.duitang.com/uploads/item/201605/14/20160514091932_WCmEc.jpeg', 'dev', '18935398186', 'mhw828@sina.com', '898658615', 'dev工程师', '北斗数睿');
INSERT INTO _user (_user_id, _name, _age, _sex, _department, _job_title, _avatar, _signature, _phonenumber, _email, _qq,
                   _introduction, _company)
...
INSERT INTO _message_list (_room_id, _room_type, _message_id, _message_type, _event_id, _time)VALUES ('room001', '_p2p', 'message001', '_text', 'event001', 1580895330);
...
INSERT INTO _task_list (_user_id, _task_id)VALUES ('maohuawei', 'task001');
...
INSERT INTO _task (_task_id, _task_name, _task_desc, _task_creator_id, _task_executor_id, _task_create_time,_task_start_time, _task_end_time, _task_remark, _task_supervisor, _task_priority)VALUES ('task001', '登录面板', '使用户能够扫描二维码登录系统', 'maohuawei', 'maohuawei', 1580898126, 1580898126, 1580898126, '难度一般','maohuawei', '高');
...
INSERT INTO _room_list (_user_id, _room_id, _room_type)VALUES ('maohuawei', 'room001', '_p2p');
...
INSERT INTO _room_p2p (_room_id, _room_name, _room_avatar, _room_version)VALUES ('room001', '毛华伟', 'https://b-ssl.duitang.com/uploads/item/201605/14/20160514091932_WCmEc.jpeg', 1);
...
INSERT INTO _message_text (_room_id, _message_id, _event_id, _sender_id, _time, _text_content, _message_sender_time, _message_receive_time, _is_me, _is_read)VALUES ('room001', 'message001', 'event001', 'maohuawei', 1580957514429, '在吗', 1580957514429, 1580957514429, true,true);
